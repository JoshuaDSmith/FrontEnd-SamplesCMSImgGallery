...
<html lang="en">
  <head>
    ...
    <link href="./Script.js" text="javascript/text"/>
    
    <title>Document</title>
  </head>
  <body class="PaddingHorizontal Column">
    <div class="Sticky DisplayOnTop Background">
      ...
      <div class="Full">
        <ul class="RowColumn Full Background Center BorderBottom ">
          ...
          <li class="dropdown ColorChangeonHover PaddingHorizontal">
            <a href="#About" class="Bold1 dropbtn">Womens</a>
            <ul class="dropdown-content Column">
              <li><a href="#">Sales</a></li>
          ...
          <li class="PaddingHorizontal ColorChangeonHover"><a class="Bold1" href="./WebsitePages/NewArrivals.php">New Arrivals</a></li>
          <li class="PaddingHorizontal ColorChangeonHover"><a class="Bold1">Sales</a></li>
      </div>
    </div>

    <div id="slides" class="Full">
        <div class="slide ConditionalCenter showing">
            <img src="./Canteens/patrick-tomasso-GXXYkSwndP4-unsplash.jpg"/>
            <p>Slide 1</p>
        </div>
        <div class="slide">
            <img src="./Canteens/nick-karvounis-Ciqxn7FE4vE-unsplash.jpg"/>
            <p>Slide 2</p>
        </div>
        <div class="slide">
            <img src="./Canteens/luana-niemann-uArnumExMcY-unsplash.jpg"/>
            <p>Slide 3</p>
        </div>
        <div class="slide">
            <img src="./Canteens/carlos-lindner-sjBYA8dAw54-unsplash.jpg"/>
            <p>Slide 4</p>
        </div>
        <div class="slide">
            <img src="./Canteens/gor-davtyan-0BIvjaQwvQQ-unsplash.jpg"/>
            <p>Slide 5</p></div>
        </div>
    </div>

    <ul class="RowColumn MarginTop Full Background BorderBottom">
      <li>
        <a href="#" class="FontColor1 Bold2">Trust Our Values | We Value Your Trust</a>
      </li>
      <li class="Right ColorChangeonHover">
        <a class="FontColor1 Bold1" href="#Home">See More</a>
      </li>
      <li class="ColorChangeonHover">
        <a class="Bold1 FontColor1" href="#About">Refer a Friend</a>
      </li>
   
    </ul>


    <div class="RowColumn PaddingVertical">
        <div class=""> 
          <img class=""  src="./Canteens/jose-murillo-svzLN-hSvBQ-unsplash.jpg"/>
        </div>
          <ul class="Column" >
            <li>
    ...
    <div class="RowColumn PaddingVertical">
      <div class=""> 
        <img class=""  src="./Canteens/annie-spratt-L0nm-vBylqY-unsplash.jpg"/>
      </div>
        <ul class="Column" >
          <li>
                <h2>Our Testimonals</h2>
    ...
    <div class="Row Full StrictHeight MarginVertical ">
  ...
  <ul class="RowColumn Down Full Background BorderBottom MarginVertical2">
    <li>
      <a href="#" class="FontColor1 Bold2">FANTASMA </a><a>| Collective</a>
    </li>
    <li class="Right ColorChangeonHover">
